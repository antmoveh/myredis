...
import (
	...
	"myredis/pkg/types/data/utils"
	"myredis/pkg/types/scheme"
	"testing"
)

func AssertIntReply(t *testing.T, actual scheme.Reply, expected int) {
...
func AssertBulkReply(t *testing.T, actual scheme.Reply, expected string) {
...
func AssertMultiBulkReply(t *testing.T, actual scheme.Reply, expected []string) {
