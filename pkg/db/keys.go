...
func Del(db *DB, args [][]byte) scheme.Reply {
	if len(args) == 0 {
...
func Exists(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func FlushDB(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 0 {
...
func FlushAll(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 0 {
...
func Type(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func Rename(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func RenameNx(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func Expire(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func ExpireAt(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func PExpire(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func PExpireAt(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func TTL(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func PTTL(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
