...
import (
	...
	List "myredis/pkg/types/data/list"
...
func LIndex(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 2 {
...
func LLen(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 1 {
...
func LPop(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 1 {
		return reply.MakeErrReply("ERR wrong number of arguments for 'lindex' command")
	}
...
func LPush(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func LPushX(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func LRange(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 3 {
...
func LRem(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 3 {
...
func LSet(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 3 {
...
func RPop(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 1 {
...
func RPopLPush(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func RPush(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) < 2 {
...
func RPushX(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
		return reply.MakeErrReply("ERR wrong number of arguments for 'rpush' command")
	}
	key := string(args[0])
