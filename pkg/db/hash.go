...
import (
	...
	Dict "myredis/pkg/types/data/dict"
...
func HSet(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 3 {
...
func HSetNX(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 3 {
...
func HGet(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 2 {
...
func HExists(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 2 {
...
func HDel(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) < 2 {
...
func HLen(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args) != 1 {
...
func HMSet(db *DB, args [][]byte) scheme.Reply {
	// parse args
...
func HMGet(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func HKeys(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func HVals(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func HGetAll(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func HIncrBy(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 3 {
...
func HIncrByFloat(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 3 {
