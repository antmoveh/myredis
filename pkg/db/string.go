...
func Get(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func Set(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func SetNX(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func SetEX(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 3 {
...
func PSetEX(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 3 {
...
func MSet(db *DB, args [][]byte) scheme.Reply {
...
func MGet(db *DB, args [][]byte) scheme.Reply {
	if len(args) == 0 {
...
func MSetNX(db *DB, args [][]byte) scheme.Reply {
	// parse args
	if len(args)%2 != 0 || len(args) == 0 {
...
func GetSet(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func Incr(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func IncrBy(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func IncrByFloat(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func Decr(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func DecrBy(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
