...
import (
	...
	HashSet "myredis/pkg/types/data/set"
...
func SAdd(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func SIsMember(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 2 {
...
func SRem(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func SCard(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func SMembers(db *DB, args [][]byte) scheme.Reply {
	if len(args) != 1 {
...
func SInter(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 1 {
...
func SInterStore(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func SUnion(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 1 {
...
func SUnionStore(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func SDiff(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 1 {
...
func SDiffStore(db *DB, args [][]byte) scheme.Reply {
	if len(args) < 2 {
...
func SRandMember(db *DB, args [][]byte) scheme.Reply {
